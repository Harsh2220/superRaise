  ...
  return (
    ...
    <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        <div className="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
            <img className="hidden w-full lg:block" src='./credit-cards.png' alt="" />
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20 pt-20">
            <div className="max-w-xl mx-auto text-center">
                <h1 className="text-4xl font-bold sm:text-6xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Where Innovation Meets Support </span>
                </h1>
                <p className="mt-5 text-base text-white sm:text-xl">Elevate your crowdfunding experience with SuperRaise</p>
                ...
                <div className="grid grid-cols-1 px-20 mt-20 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Create Campaigns</p>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Invest in Campaigns</p>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Everything Realtime</p>
                    </div>
                </div>
            </div>
        </div>
